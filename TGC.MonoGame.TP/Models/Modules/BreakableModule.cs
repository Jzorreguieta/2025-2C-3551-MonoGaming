...
internal class BreakableModule : IModule
{
    ...
    public BreakableModule(ContentManager content, string contentFolder3D, string contentFolderEffects, Matrix worldMatrix)
    {
